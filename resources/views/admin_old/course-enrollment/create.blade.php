...
@section('title', __('Create') . " " . __('Course Student'))

@section('header')
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        {{ __('Create') . " " . __('Course Student') }}
    </h2>
@endsection
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Create') }} Course Student</h1>
                            <p class="mt-2 text-sm text-gray-700">Add a new {{ __('Course Student') }}.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="max-w-xl py-2 align-middle">
                                <form method="POST" action="{{ route('course-enrollment.store') }}"  role="form" enctype="multipart/form-data">
                                    @csrf
